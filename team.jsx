/* global React */
// Team page — founders, board, story, vision, apply CTA.
// Uses shared Nav + Footer + DemoModal from the main bundle.
  ...
  return (
    <section className="team-hero">
      <div className="container">
        ...
        <p className="team-lede">Our founding team comes from across the construction and technology industry. Owners, builders, designers, and engineers who've lived the problems we now build against.
          ...
          <article className="team-card" key={m.name}>
              ...
              style={{
                ...
                <img
                  ...
                  loading="lazy"
                />
                <div className="team-avatar-tint" style={{
    ...
    <section className="team-story">
      <div className="container team-story-grid">
        <div className="team-story-col">
          ...
          <p>Block and Mortar was started by industry practitioners who saw the need for a better way of doing real estate development  one that was more collaborative, with technology that was actually good.
        ...
        <div className="team-story-col">
          ...
          <p>Block and Mortar unifies the entire development lifecycle  seamlessly connecting information, partners, and execution into a single intelligent platform.
      ...
      <div className="container">
        <div className="team-apply-card">
          <div>
            ...
            <h2 className="team-apply-h">We're building the future of the built environment  and we want people who'll shape it, not just work in it.

            </h2>
            <p>If you're driven to rethink how projects get designed, delivered, and scaled and you thrive at the intersection of technology, infrastructure, and real-world impact  we'd love to hear from you.
          ...
          <div className="team-apply-actions">
            <a
              href="mailto:info@blockandmortar.ai?subject=Candidate%20Interest"
